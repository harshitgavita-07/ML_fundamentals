...
├── 05_locally_weighted_linear_regression.ipynb
├── 06_logistic_regression.ipynb
├── 07_knn_algorithm.ipynb
├── 08_support_vector_machine.ipynb
├── 09_naive_bayes_classifier.ipynb
├── 10_decision_trees.ipynb
├── 11_random_forest.ipynb
├── 12_boosting_algorithms.ipynb
├── 13_neural_networks.ipynb
├── 14_activation_functions.ipynb
├── 15_backpropagation.ipynb
├── 16_loss_functions.ipynb
├── 17_optimization_algorithms.ipynb
├── 18_k_means_clustering.ipynb
├── 19_dimensionality_reduction_pca.ipynb
...
Then open any notebook and explore.
